...
@section('main')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Tin nhắn đã đọc</h1>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a class="btn btn-success" href="{{ route('admin.message.index') }}">Xem tin mới</a>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-warning"
                                                href="{{ route('admin.message.show_deleted_detail', ['id' => $item->id]) }}"
                                                >Xem lại</a>
                                        </td>
                                    </tr>
                                @endforeach
