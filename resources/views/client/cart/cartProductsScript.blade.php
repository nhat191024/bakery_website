<script>
    ...
    function calculateTotal(discount = 0) {
        ...
        $('#totalPrice').text(subTotal - discount < 0 ? 0 : new Intl.NumberFormat('de-DE').format(subTotal - discount) +
            'đ');

        $('#subTotal').text(subTotal < 0 ? 0 : new Intl.NumberFormat('de-DE').format(subTotal) + 'đ');

        $('#discountPrice').text((discount < 0 ? 0 : (new Intl.NumberFormat('de-DE').format(discount))) + 'đ');
    }
